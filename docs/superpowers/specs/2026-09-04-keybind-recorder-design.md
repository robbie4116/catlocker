...
- Failure-path coverage will distinguish a benign `False` controller response from `EngineUnhealthy`, asserting cleanup, display restoration, control synchronization, and fatal routing as appropriate.
